...
### T1-1. ETF 명칭 통일 (SPY vs QQQ)
- **문제**: Abstract/영문요약에 "SPY (S&P 500)" 기재, 실제 코드는 QQQ (NASDAQ-100) + SOXX 사용
- **영향**: 심사위원이 데이터 섹션과 Abstract를 교차 확인하면 즉시 발견
- **수정 방법**:
  - Option A (권장): 논문 전체에서 SPY → QQQ로 통일하고 S&P 500 → NASDAQ-100으로 수정
  - Option B: 코드를 SPY로 재실행하고 결과 교체
  - P40, P41, P51, P58, P60, P62 등 SPY 언급 부분 전수 수정 필요
- **난이도**: 낮음 (텍스트 교체)
