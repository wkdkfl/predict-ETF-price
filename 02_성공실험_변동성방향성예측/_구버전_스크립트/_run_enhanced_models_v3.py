# -*- coding: utf-8 -*-
"""Phase 3 v3 — Improved Volatility & Direction prediction.
...
def run_market(market_code: str) -> Dict:
    print(f"\n{'='*60}\n  {market_code} -- V3: IMPROVED VOLATILITY & DIRECTION\n{'='*60}")
    sub = "USD" if market_code == "US" else "UK"
    out_dir = BASE / sub / "results_v3"
    ...
    print(f"  base rate (up days in test): {test['target_dir'].mean():.3f}")
