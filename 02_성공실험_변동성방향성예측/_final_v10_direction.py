...
def main():
    ...
    res.to_csv(RES / "_final_v10_direction.csv", index=False, encoding="utf-8-sig")
    pd.DataFrame(dm_rows).to_csv(RES / "_final_v10_dm_dir.csv", index=False, encoding="utf-8-sig")
    print("\n저장 완료")
